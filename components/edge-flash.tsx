...
const TEMP_COLORS = {
  neutral: '#FFFFFF',
  warm: '#FFEAA7', // warm gold/candlelight
  cool: '#E3F2FD', // cool ice blue
};

export function EdgeFlashOverlay({
  visible,
  brightness = 1.0,
  temperature = 'neutral',
}: {
  ...
  const animatedStyle = useAnimatedStyle(() => ({
    opacity: opacity.value * brightness,
  }));
  ...
  const flashColor = TEMP_COLORS[temperature] ?? '#FFFFFF';
      ...
      <Svg width={W} height={H} viewBox={`0 0 ${W} ${H}`}>
        <Defs>
          ...
          <SvgLinearGradient id="gt" x1="0" y1="0" x2="0" y2={DEPTH_TOP} gradientUnits="userSpaceOnUse">
            <Stop offset="0%"   stopColor={flashColor} stopOpacity={1} />
            <Stop offset="40%"  stopColor={flashColor} stopOpacity={1} />
            <Stop offset="60%"  stopColor={flashColor} stopOpacity={0} />
          </SvgLinearGradient>
          ...
          <SvgLinearGradient id="gl" x1="0" y1="0" x2={DEPTH_H} y2="0" gradientUnits="userSpaceOnUse">
            <Stop offset="0%"   stopColor={flashColor} stopOpacity={1}    />
            <Stop offset="12%"  stopColor={flashColor} stopOpacity={1}    />
            <Stop offset="40%"  stopColor={flashColor} stopOpacity={0.60} />
            <Stop offset="70%"  stopColor={flashColor} stopOpacity={0.25} />
