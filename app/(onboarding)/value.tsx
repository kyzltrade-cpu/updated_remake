      ...
      <Animated.View entering={FadeInUp.delay(250).duration(700)} style={styles.features}>
        <View style={styles.feature}>
          ...
          <View style={styles.featureText}>
            <Text style={styles.featureTitle}>Sees Your Real Makeup</Text>
            <Text style={styles.featureDesc}>Not just skin — it reads your products, layers, and technique.</Text>
          </View>
        </View>
        <View style={styles.feature}>
          <Text style={styles.featureEmoji}>◈</Text>
...
const styles = StyleSheet.create({
  ...
  features: { flex: 1, gap: 30, paddingTop: 20 },
  feature: { flexDirection: 'row', gap: 18, alignItems: 'flex-start' },
  featureEmoji: {
    fontSize: 22,
