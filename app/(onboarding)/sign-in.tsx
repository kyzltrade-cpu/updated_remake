    ...
    >
      ...
      >
        <View style={{ flex: 1 }}>
          ...
          <Animated.View entering={FadeInUp.delay(360).duration(500)} style={{ marginBottom: 16 }}>
            <Pressable
      ...
      {/* Bottom Section - Outside KeyboardAvoidingView */}
      <Animated.View entering={FadeInUp.delay(360).duration(500)} style={styles.bottom}>
        ...
        <View style={styles.ssoButtons}>
          <Pressable style={[styles.ssoBtn, styles.appleBtn]} onPress={handleAppleSignIn}>
            <FontAwesome name="apple" size={17} color="#FFFFFF" style={styles.ssoIcon} />
